...
public class SimpleCrypto {
		...
		private static byte[] initializationVector = {1, 64, 12, 36, 48, 77, 42, 16, 25, 15, 43, 11, 7, 14, 88, 99};
        ...
        public static byte[] encryptByte(String seed, byte[] bytes) throws Exception {
            byte[] rawKey = getRawKey(seed.getBytes());
        ...
        public static byte[] decryptByte(String seed, byte[] encrypted) throws Exception {
            byte[] rawKey = getRawKey(seed.getBytes());
